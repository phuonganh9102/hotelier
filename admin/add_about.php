        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <h1 class="mb-5"><span class="text-primary text-uppercase">Thêm Mới</span> About</h1>
                </div>
                <div class="row g-4">
                    <div class="col-12">
                        <div class="row gy-4">
                        ...
                        <div class="wow fadeInUp" data-wow-delay="0.2s">
                            <form action="" method="post" enctype="multipart/form-data">
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            Chọn Ảnh :
                                            <input type="file" name="txtfile" class="form-control" placeholder="">
                                    ...
                                    <div class="col-12">
                                        <div class="form-floating">
                                            Mô Tả:
                                            <input type="text" name="txtmota" class="form-control" placeholder="">
                                    ...
                                    <div class="col-12">
                                        <button name="txtsub" class="btn btn-primary w-100 py-3" type="submit">Đăng
                                            Bài</button>
                                    </div>
                                </div>
                            </form>
                            ...
                            if (isset($_POST['txtsub'])) // thực thi sau khi nhấn nút submit
                            {
                                ...
                                $insert = $get_data->insert_about(
                                    $_POST['txtname'],
                                    $_FILES['txtfile']['name'],
                                    $_POST['txtmota'],
                                    $_POST['txtchitiet']
                                );
                                if ($insert) { echo "<script>alert('Thêm mới thành công')</script>";
