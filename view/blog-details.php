...
<body>
    <div class="container-xxl bg-white p-0">
        ...
        include('control.php');
        $get = new data();
        $select_about = $get->select_about_id($id_blog);
            ...
            <div class="container">
                <div class="row g-5">
                    ...
                    <div class="col-lg-8">
                        ...
                        <div id="blog-carousel" class="carousel slide mb-5 wow fadeIn" data-bs-ride="carousel" data-wow-delay="0.1s">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img class="w-100" src="../resources/img/blog/<?php echo $se_about['anh1'] ?>" alt="Image">
                                </div>
                                <div class="carousel-item">
                                    <img class="w-100" src="../resources/img/blog/<?php echo $se_about['anh2'] ?>" alt="Image">
                                </div>
                                <div class="carousel-item">
                                    <img class="w-100" src="../resources/img/blog/<?php echo $se_about['anh3'] ?>" alt="Image">
                                </div>
                            </div>
                        ...
                        <div class="d-flex mb-3">
                            <span class="border-end me-3 pe-3"><i class="fa fa-user-alt text-primary me-2"></i><?php echo $se_about['tac_gia'] ?></span>
                            <!-- Ngày viết bài -->
                            <span><i class="fa fa-calendar-alt text-primary me-2"></i>
                            <?php
                        ...
                        <h1 class="mb-4"><?php echo $se_about['ten_blog'] ?></h1>
                        <p><?php echo $se_about['bai_blog'] ?></p>
                        <div class="row g-4 mb-4">
                            <div class="col-sm-6">
                                <img class="img-fluid" src="../resources/img/blog/<?php echo $se_about['anh2'] ?>" alt>
                            </div>
                            <div class="col-sm-6">
                                <img class="img-fluid" src="../resources/img/blog/<?php echo $se_about['anh3'] ?>" alt>
                            </div>
                        </div>
                        <figure class="border-start border-5 border-primary ps-4 mb-5">
                            <blockquote class="blockquote mb-4">
                                <p><?php echo $se_about['quote'] ?></p>
                            </blockquote>
                            <figcaption class="blockquote-footer fw-medium"><?php echo $se_about['tacgia_quote'] ?></figcaption>
                        </figure>


                        <div class="border p-1 mb-5 wow fadeIn" data-wow-delay="0.1s">
                            <div class="d-flex flex-column flex-sm-row border p-4">
                                <img class="img-fluid flex-shrink-0 mb-3 mb-sm-0" src="img/user.jpg" style="width: 100px; height: 100px;" />
                                <div class="ps-sm-3">
                                    <h5><?php echo $se_about['tac_gia'] ?></h5>
                                    <p class="mb-0"><?php echo $se_about['quote'] ?></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-5 wow fadeIn" data-wow-delay="0.1s">
                            <h4 class="section-title text-start mb-4">Related Post</h4>
                        ...
                        <div class="mb-5 wow fadeIn" data-wow-delay="0.1s">
                            <h4 class="section-title text-start mb-4">3 Comments</h4>
                        ...
                        <div class="bg-light p-4 p-md-5 wow fadeIn" data-wow-delay="0.1s">
                            <h4 class="section-title text-start mb-4">Leave A Comment</h4>
                            <form>
                                <div class="row g-3">
